...
The code for both the [SpeakEasy modeling](https://github.com/BotScutters/SpeakEasy) and [SpeakEasy app](https://github.com/BotScutters/speakeasy-app) are available here, and you can read a much more in depth breakdown of how I built it on my [blog](http://scottbutters.com/articles/2019/05/27/Speakeasy-AI-Bartender/).